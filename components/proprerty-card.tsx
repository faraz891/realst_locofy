...
type ProprertyCardType = {
  carDimensions?: string;
};

const ProprertyCard: NextPage<ProprertyCardType> = ({ carDimensions }) => {
  return (
    <div className="flex-1 rounded-3xs bg-white box-border h-[467px] flex flex-col items-start justify-start py-[15px] px-[13px] gap-[23px] min-w-[355px] max-w-[400px] text-left text-[14.51px] text-gray-700 font-body-large-400 border-[1px] border-solid border-whitesmoke hover:bg-gainsboro hover:cursor-pointer sm:w-[100%!important] sm:mb-5">
      <img
      ...
      <div className="self-stretch flex flex-row items-start justify-start p-2.5 text-[13.55px] text-red">
